...
#define OMAP4430_VDD_MPU_OPPNITRO_UV        1388000
#define OMAP4430_VDD_MPU_OPPNITROSB_UV      1398000
#define OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV  1410000
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	...
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
    ...
    VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_FAST_OPP),
...
//	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_UV},
	{.main_vdd_volt = OMAP4430_VDD_MPU_OPPNITROSB_UV, .dep_vdd_volt = OMAP4430_VDD_CORE_OPP100_OV_UV},
};
...
static struct omap_opp_def __initdata omap443x_opp_def_list[] = { //Possible Clockspeeds
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 330000000, OMAP4430_VDD_MPU_OPP50_UV), //Liftet from 300 to 330 MHz
	/* MPU OPP2 - OPP100 */
	...
	/* MPU OPP4 - OPP-NT */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1008000000, OMAP4430_VDD_MPU_OPPNITRO_UV), //Default Max Clock
	/* MPU OPP4 - OPP-Nitro */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1200000000, OMAP4430_VDD_MPU_OPPNITROSB_UV), //Overclock to 1,2 GHZ (Default Limit 1080)
	/* MPU OPP4 - OPP-Nitro SpeedBin */
	OPP_INITIALIZER("mpu", "dpll_mpu_ck", "mpu", true, 1500000000, OMAP4430_VDD_MPU_OPPNITROSBPLUS_UV), //Overclock to 1,4GHz
	/* MPU OPP5 - OPP-SB */
    ...
    /* SGX OPP3 - OPP100 */
    OPP_INITIALIZER("gpu", "dpll_per_m7x2_ck", "core", true, 384000000, OMAP4430_VDD_CORE_OPP100_OV_UV),
	/* FDIF OPP1 - OPP25 */
...
struct omap_volt_data omap446x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP50_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 0, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	/* MPU OPP1 - OPP50 */
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", true, 330000000, OMAP4460_VDD_MPU_OPP50_UV), //Liftet minimum clock from 300 to 330 MHz
	/* MPU OPP2 - OPP100 */
...
int __init omap4_opp_init(void)
{
	...
	if (cpu_is_omap443x())
		...
		trimmed = omap_readl(0x4a002268) & ((1 << 18) | (1 << 19)); // Comment out to disable
    ...
    if (omap4_has_mpu_1_5ghz()) //Ignore trimming, force enabling 1,5 GHz
